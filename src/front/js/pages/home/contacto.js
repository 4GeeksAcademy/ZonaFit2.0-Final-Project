            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="ml-auto col-lg-5 col-md-6 col-12 contact-info">
                        <h2 className="mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">Sientete libre de preguntar cualquier duda </h2>
                    ...
                    <div className="mx-auto mt-4 mt-lg-0 mt-md-0 col-lg-5 col-md-6 col-12 contcat-map">
                        <h2 className="mb-4" data-aos="fade-up" data-aos-delay="600">Donde puedes encontrarnos <span>Ubicanos</span></h2>
